...
UPDATE tb_productos SET costo=? WHERE nombre=?;
UPDATE tb_productos_sucursales SET stock= ? WHERE id_producto= ?;
UPDATE tb_productos_sucursales SET costo= ? WHERE id_producto= ?;

/***************************Carga elimina stock*****************************/


DELETE FROM tb_productos_sucursales WHERE id_tbproducto=? AND id_tbsucursal=? AND stock=?;

/**********************************************************************/
 SET @id_producto= LAST_INSERT_ID();

INSERT INTO tb_productos_sucursales ( id_tbsucursal, id_tbproducto) VALUES (2,@id_producto);
INSERT INTO tb_productos_sucursales ( id_tbsucursal, id_tbproducto,stock) VALUES (2,@id_producto,100);
